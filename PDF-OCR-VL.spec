...
"""
PyInstaller spec file for PaddleOCR-VL Standalone OCR Tool
（参考 PDF-OCR.spec 结构；第一版以脚本运行验证为主，本 spec 仅作参考）
"""
...
hiddenimports = [
    ...
    'app.core',
    'app.core.ocr_engine',
    'app.core.ocr_engine_base',
    'app.core.ocr_engine_paddle_vl',
    'app.core.ocr_doc_processor',
    'app.core.ocr_exporter',
    'app.core.pdf_loader',
    ...
    'app.models',
    'app.models.page_result',
    'app.models.region',
    'app.models.template',
    'app.models.ocr_result',
    'app.ui',
    'app.ui.main_window',
    'app.ui.windows.ocr_main_window',
    'app.ui.widgets',
    'app.ui.widgets.ocr_file_panel',
    'app.ui.widgets.ocr_result_views',
    'app.ui.widgets.ocr_parse_config_dialog',
...
a = Analysis(
    ['main_ocr.py'],
    pathex=[str(project_root), str(venv_site_packages)],  # paddle/paddlex 在 venv-paddle 中
    binaries=[],
    datas=datas,
